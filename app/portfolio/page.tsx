...
const projects = [
  ...
  },
  {
    ...
    num: '03',
    title: 'TMS Intérim',
    subtitle: 'Plateforme généraliste de recrutement intérim',
    category: 'Web + Recrutement',
    year: '2026',
    description: 'Plateforme d\'intérim couvrant 7 secteurs — logistique, BTP, industrie, nettoyage, hôtellerie-restauration, bureau et maintenance technique. Espace employeur, gestion des candidatures et architecture pensée pour une mise à l\'échelle rapide.',
    tags: ['Next.js 15', 'Supabase', 'Stripe', 'Resend', 'Vercel'],
    url: '#',
    color: '#1D4ED8',
    metrics: [
      { val: '7', label: 'Secteurs couverts' },
      { val: '100%', label: 'Sur-mesure' },
      { val: 'Bientôt', label: 'Lancement' },
    ],
  },
  {
    id: 'cleanatis',
    num: '04',
    title: 'CLEANATIS',
    subtitle: 'Société de nettoyage professionnel — Bordeaux',
    category: 'Web + Devis en ligne',
    year: '2026',
    description: 'Site vitrine et devis en ligne pour une société de nettoyage professionnel à Bordeaux — formulaire de devis en 3 étapes connecté à une base sécurisée, parcours dédiés particuliers et professionnels, carte interactive de la zone d\'intervention.',
    tags: ['Next.js', 'Supabase', 'Framer Motion', 'Vercel'],
    url: '#',
    color: '#1DB88A',
    metrics: [
      { val: '3', label: 'Étapes devis' },
      { val: '100%', label: 'Sur-mesure' },
      { val: 'Bientôt', label: 'Lancement' },
    ],
  },
