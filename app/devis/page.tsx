...
export default function Devis() {
  ...
  const handleSend = async () => {
    ...
    setSending(true)
    // Simulation envoi — on ajoutera Resend plus tard
      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '60px 24px' }}>
        ...
        {!result ? (
          ...
          <div style={{ textAlign: 'center', padding: '60px 0' }}>
            ...
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '18px', color: 'var(--blue-muted)', fontStyle: 'italic', marginBottom: '32px' }}>
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' }}>
                <div>
                  <div style={{
                    fontFamily: "'Cormorant Garamond', serif",
                    fontSize: '32px', fontWeight: 600, color: 'var(--gold)',
                  }}>{packs[result].name}</div>
                  <div style={{
                    fontFamily: "'Cormorant Garamond', serif",
                    fontSize: '48px', fontWeight: 600, color: 'var(--white)', lineHeight: 1,
                  }}>{packs[result].price}</div>
                </div>
                <div style={{
                  background: 'linear-gradient(135deg, #f5d480, #d4a017, #b8860b)',
            ...
            <div style={{
              ...
              <div style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontSize: '24px', fontWeight: 600, color: 'var(--gold)',
                marginBottom: '24px',
              }}>Demander ce devis</div>
              ...
              <div style={{ marginBottom: '24px' }}>
                <label style={{
                  ...
                  letterSpacing: '2px', textTransform: 'uppercase', color: 'var(--gold)',
                  display: 'block', marginBottom: '8px',
                }}>Décrivez votre projet (optionnel)</label>
              ...
              <button onClick={() => { setResult(null); setCurrentStep(0); setScores({ starter: 0, pro: 0, studio: 0, retainer: 0 }); setAnswers({}) }}
                style={{
